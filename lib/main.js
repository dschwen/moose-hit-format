...
import ClangFormat from './hit-format';
...
export default {
  config: {
    ...
    fallbackStyle: {
      type: 'string',
      default: 'llvm',
      description: 'Fallback Style. Set To "none" together with style "file" to ensure that if no ".hit-format" file exists, no reformatting takes place.',
    },
  },

  activate() {
    this.hitFormat = new ClangFormat();
  },
